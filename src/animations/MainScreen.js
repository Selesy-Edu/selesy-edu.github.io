  ...
  componentDidMount(){
    ...
    const code = (sketch) => {
      ...
      sketch.draw = () => {
        ...
        //COLUMBIA BRITANICA
        sketch.image(house1,width*0.175,height*0.2,width*0.036,height*0.06)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //KANSAS
        sketch.image(house2,width*0.225,height*0.28,width*0.03,height*0.07)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //MASSACHUSETS
        sketch.image(house3,width*0.3,height*0.26,width*0.045,height*0.045)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //COSTA RICA
        sketch.image(house4,width*0.27,height*0.44,width*0.045,height*0.045)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //AMAZONAS
        sketch.image(house5,width*0.322,height*0.5,width*0.04,height*0.04)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //RIO DE JANEIRO
        sketch.image(house6,width*0.38,height*0.62,width*0.04,height*0.052)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //ZAMBIA
        sketch.image(house7,width*0.58,height*0.58,width*0.04,height*0.052)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //ETIOPIA
        sketch.image(house8,width*0.615,height*0.445,width*0.04,height*0.052)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //HOLANDA
        sketch.image(house9,width*0.545,height*0.21,width*0.04,height*0.052)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //FRANCIA
        sketch.image(house10,width*0.51,height*0.24,width*0.04,height*0.052)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //FINLANDIA
        sketch.image(house11,width*0.58,height*0.13,width*0.037,height*0.05)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //MOSCÚ
        sketch.image(house12,width*0.605,height*0.20,width*0.038,height*0.062)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //CHINA
        sketch.image(house13,width*0.8,height*0.34,width*0.05,height*0.064)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //JAPÓN
        sketch.image(house14,width*0.89,height*0.30,width*0.05,height*0.065)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //SIBERIA
        sketch.image(house15,width*0.78,height*0.16,width*0.041,height*0.065)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //NUEVA GUINEA
        sketch.image(house16,width*0.9,height*0.51,width*0.041,height*0.065)
        sketch.pop()
        sketch.push()
        ...
        //INDONESIA
        sketch.image(house17,width*0.815,height*0.48,width*0.041,height*0.085)
        sketch.pop()
        sketch.push()
        sketch.tint(80,80,80,100)
        //GROENLANDIA
        sketch.image(house18,width*0.395,height*0.08,width*0.045,height*0.055)
        sketch.pop()
