        ...
        <div className="container">
          <div class="card margin-top overflow" style={{width: "20rem;"}}>
            <div class="card-body">
              ...
              <h6 class="card-subtitle mb-2 text-muted">Somos un grupo de idealistas.</h6>
              <p class="card-text">
              ...
              <h6 class="card-subtitle mb-2 text-muted">Aquí encontrarás una plataforma.</h6>
              <p>
              ...
              <h6 class="card-subtitle mb-2 text-muted">Nuestro presente.</h6>
              <p>
